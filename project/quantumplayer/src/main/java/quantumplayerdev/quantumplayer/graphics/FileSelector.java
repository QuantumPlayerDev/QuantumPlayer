...
/**
 * The FileSelector class creates a new {@link TreeView} object that contains
 * {@link FileView} object to represent the structure of all {@link File}
 * objects that exist on a local device.
 * 
 * @author daniel
 *
 */
public class FileSelector extends TreeView<FileView> {
	...
	/**
	 * Constructor for creating a new {@link FileSelector} object to represent
	 * all files that exist depending on the {@link #rootFile}.
	 * 
	 * @param rootFile
	 *            The root file to set.
	 */
	 ...
	 */
	private void style() {
		this.setStyle("-fx-font-weight: bold; -fx-background-color: black;" + "-fx-text-fill: white;");
	}
