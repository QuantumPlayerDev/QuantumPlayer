...
public class CoreConstruction extends BorderPane {
	...
	public CoreConstruction(final WindowManager manager) {
		super();
		String resourcePath = "file:///" + System.getProperty("user.dir").replace("\\", "/") + "/src/main/resources/";
		...
		final ImageView imageClose = new ImageView(new Image(resourcePath + "images/png/007__close.png"));
		...
		final ImageView imageIconify = new ImageView(new Image(resourcePath + "images/png/006__minus.png"));
		...
		final ImageView imageMaximize = new ImageView(new Image(resourcePath + "images/png/053__desktop.png"));
